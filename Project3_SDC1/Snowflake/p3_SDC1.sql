...
CREATE OR REPLACE STORAGE INTEGRATION SCD1_INT
  ...
  STORAGE_PROVIDER = 'S3'
  ENABLED = TRUE
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::000185048470:role/p3_scd1_role'
  STORAGE_ALLOWED_LOCATIONS = ('s3://p3-scd1-data-bucket/data/');
...
CREATE OR REPLACE STAGE SCD1_DB.PUBLIC.SCD1_STAGE 
  ...
  URL = 's3://p3-scd1-data-bucket/data/';

LIST @SCD1_DB.PUBLIC.SCD1_STAGE;

-- CREATE CUSTOMER_SOURCE TABLE
